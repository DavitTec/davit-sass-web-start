...
All notable changes to the ["https://github.com/DavitTec/davit-sass-web-start"](https://github.com/DavitTec/davit-sass-web-start) project will be documented in this file.
...
Update to v0.0.2 (1df53e6…)

Update index for rel root (ca3e586…)

Build.sh again (6ff9c6b…)

Build.sh v0.1.2 (e27b760…)

Build.sh v 0.1.1 (3bf6808…)

Build.sh v0.1.0 (e17c7f7…)

Build.sh v0.0.2 (b396c76…)

Add sample robots.txt (102a346…)

Update stage.sh and build.sh (10c79ba…)

### 🚀 Features

Add manfiest.json example (3b53112…)

## [0.0.1] - 2025-12-11 ([v0.0.1](https://github.com/DavitTec/davit-sass-web-start/releases/tag/v0.0.1))

### 🚀 Features

Initial commit (4267ca3…)
